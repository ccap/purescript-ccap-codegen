...
let additions =
  { boxes = mkPackage
      ...
      "https://github.com/cdepillabout/purescript-boxes"
      "v1.0.1"
  , postgresql-client = mkPackage
      ...
      -- "https://github.com/pbrant/purescript-postgresql-client" "update-dependencies"
     "https://github.com/rightfold/purescript-postgresql-client"
     "v3.0.0-alpha"
  , stringutils = mkPackage
      [ "strings"
      , "partial"
      , "arrays"
      , "either"
      ...
      "https://github.com/menelaos/purescript-stringutils"
      "v0.0.8"
  , bytestrings = mkPackage
      [ "node-buffer"
      , "prelude"
      , "effect"
      , "quickcheck"
