...
getSchemaConfig = ado
  ...
  in case domains, maybeTable of
    ...
    false, Nothing -> Left "The table option should be used iff the domain option is not."
    true, Just _ -> Left "The table option should be used iff the domain option is not."
