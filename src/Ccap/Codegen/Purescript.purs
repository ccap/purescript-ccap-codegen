...
oneModule defaultModulePrefix all mod = vsep 1 Boxes.left do
  let env = { defaultPrefix: defaultModulePrefix, currentModule: mod { imports = mod.imports <#> _.pursPkg }, allModules: all }
      Tuple body imports = runCodegen env (traverse typeDecl mod.types)
  text "-- This file is automatically generated. Do not edit."
    : text ("module " <> modulePrefix defaultModulePrefix mod.annots <> "." <> mod.name <> " where")
