...
oneModule defaultModulePrefix all mod@(Module name decls annots impts) = vsep 1 Boxes.left do
  ...
  text "-- This file is automatically generated. Do not edit."
    ...
    : vcat Boxes.left ((renderImports <<< mergeImports $ imports <> (impts <#> importModule "")) <#> \i -> text ("import " <> i))
    : body
...
modPrefix all modName = do
  Module _ _ annots _ <- Array.find (\(Module n _ _ _) -> n == modName) all
